...
async function run() {
  ...
  // ── Step 1: Identify estate_cleanout businesses still needing a real photo ─
  ...
  console.log(`  ${allBizs.length} total estate_cleanout businesses`)
  ...
  // Estate businesses use multiple unsplash placeholders, so demote by domain.
  console.log('\n📸 Updating database…')
  let promoted = 0
  let errors = 0
